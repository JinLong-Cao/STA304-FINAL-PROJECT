...
my_data %>% 
  ...
  labs(x = "Response",
       y = "Frequency",
       title = "Figure 1.4: Responses to 'Are you Pro-Vaccine or Anti-Vaccine?'") +
  theme(panel.background = element_rect(fill = "lightblue1",
                                colour = "lightblue1",
                                size = 0.5, linetype = "solid"))
```
...
```{r Vaccine_Confidence, echo=FALSE}
#Vaccine Confidence
